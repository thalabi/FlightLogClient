...
export class FlightLogTableComponent implements OnInit {
    ...
    private getMakeModels() {
        this.flightLogService.getAllMakeModel().subscribe(data => {
            console.log('data', data);
            let makeModelArray: Array<string> = data;
            console.log('makeModelArray', makeModelArray);
            this.makeModelSelectItemArray = new Array<SelectItem>();
            makeModelArray.forEach(makeModel => {
                this.makeModelSelectItemArray.push({ label: makeModel, value: makeModel });
            });
        });
    }
    ...
    private getRegistrations() {
        this.flightLogService.getAllRegistration().subscribe(data => {
            console.log('data', data);
            let registrationArray: Array<string> = data;
            console.log('makeModelArray', registrationArray);
            this.registrationSelectItemArray = new Array<SelectItem>();
            registrationArray.forEach(registration => {
                this.registrationSelectItemArray.push({ label: registration, value: registration });
            });
        });
    }
